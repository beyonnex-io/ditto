 ...
 * <p>
 * {@code allowedImportAdditions} is intentionally NOT enforced here. It is a runtime filter
 * applied by {@code PolicyImporter} during reference resolution; own additions on a referencing
 * entry that violate the strictest {@code allowedImportAdditions} across all import refs are
...
public class PolicyImportsPreEnforcer implements PreEnforcer {
     ...
     * importable type, and READ access on the referenced entry. {@code allowedImportAdditions} is
