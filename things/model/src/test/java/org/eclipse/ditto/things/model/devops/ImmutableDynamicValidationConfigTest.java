...
class ImmutableDynamicValidationConfigTest {
    ...
    void testOfAndGetters() {
        ImmutableValidationContext validationContext = ImmutableValidationContext.of(
            Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), "type"
        );
        ImmutableConfigOverrides configOverrides = ImmutableConfigOverrides.of(null, null, null, null);
        ImmutableDynamicValidationConfig config = ImmutableDynamicValidationConfig.of("scope1", validationContext, configOverrides);
    ...
    void testEqualsAndHashCode() {
        ...
        ImmutableConfigOverrides configOverrides = ImmutableConfigOverrides.of(null, null, null, null);
        ImmutableDynamicValidationConfig config1 = ImmutableDynamicValidationConfig.of("scope1", validationContext, configOverrides);
        ImmutableDynamicValidationConfig config2 = ImmutableDynamicValidationConfig.of("scope1", validationContext, configOverrides);
