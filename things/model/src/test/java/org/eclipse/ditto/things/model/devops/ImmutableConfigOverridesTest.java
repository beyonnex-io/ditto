...
class ImmutableConfigOverridesTest {
    ...
    void testOfAndGetters() {
        ...
        assertEquals(true, config.getEnabled().orElse(null));
        assertEquals(false, config.getLogWarningInsteadOfFailingApiCalls().orElse(null));
    ...
    void testNullAndEmptyHandling() {
        ...
        assertFalse(config.getLogWarningInsteadOfFailingApiCalls().isPresent());
