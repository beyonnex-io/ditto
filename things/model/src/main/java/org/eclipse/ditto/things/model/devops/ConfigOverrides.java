...
/**
 * Interface for configuration overrides in WoT (Web of Things) validation.
 * This represents overrides for global configuration settings.
 */
public interface ConfigOverrides extends Jsonifiable<JsonObject> {
     ...
     * @return an optional containing the override value
     */
    Optional<Boolean> getLogWarningInsteadOfFailing();
