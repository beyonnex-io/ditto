...
/**
 * Immutable value object representing a WoT (Web of Things) validation configuration.
 * <p>
 ...
 */
@Immutable
public final class ImmutableWotValidationConfig implements Entity<WotValidationConfigRevision>{
    ...
    private final List<ImmutableDynamicValidationConfig> dynamicConfig;
    private final WotValidationConfigRevision revision;
    ...
    private ImmutableWotValidationConfig(
            ...
            final List<ImmutableDynamicValidationConfig> dynamicConfig,
            final WotValidationConfigRevision revision,
    ...
    public static ImmutableWotValidationConfig of(
        ...
        return new ImmutableWotValidationConfig(configId, enabled, logWarningInsteadOfFailingApiCalls, thingConfig, featureConfig,
                dynamicConfig, Objects.requireNonNull(revision, "revision"), created, modified, deleted, metadata);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(configId, enabled, logWarningInsteadOfFailingApiCalls, thingConfig, featureConfig, dynamicConfig,
                revision, modified, created, deleted, metadata);
    }
    ...
    public static ImmutableWotValidationConfig fromJson(final JsonObject jsonObject) {
        ...
        final ImmutableThingValidationConfig thingConfig = jsonObject.getValue(THING_FIELD)
                .map(ImmutableThingValidationConfig::fromJson)
                .orElse(null);

        final ImmutableFeatureValidationConfig featureConfig = jsonObject.getValue(FEATURE_FIELD)
                .map(ImmutableFeatureValidationConfig::fromJson)
                .orElse(null);

        final List<ImmutableDynamicValidationConfig> dynamicConfig = jsonObject.getValue(DYNAMIC_CONFIG_FIELD)
        ...
        final WotValidationConfigRevision revision = jsonObject.getValue("_revision")
                .filter(JsonValue::isNumber)
                .map(JsonValue::asLong)
                .map(WotValidationConfigRevision::of)
                .orElse(WotValidationConfigRevision.of(0L));
        ...
        final ImmutableWotValidationConfig result = of(configId, enabled, logWarningInsteadOfFailingApiCalls,
                thingConfig, featureConfig, dynamicConfig, revision, created, modified, deleted, metadata);
    ...
    public JsonObject toJson(final JsonSchemaVersion schemaVersion, final Predicate<JsonField> predicate) {
        ...
        builder.set("_revision", revision.toLong());
