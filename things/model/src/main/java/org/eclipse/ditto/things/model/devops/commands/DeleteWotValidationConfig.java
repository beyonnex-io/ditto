...
/**
 * Command to delete a WoT (Web of Things) validation configuration.
 * <p>
...
public final class DeleteWotValidationConfig extends AbstractWotValidationConfigCommand<DeleteWotValidationConfig> implements WotValidationConfigCommand<DeleteWotValidationConfig> {
    ...
    /**
     * This class contains definitions for all specific fields of a {@code DeleteWotValidationConfig}'s JSON representation.
     */
    @Immutable
    public static final class JsonFields {
         ...
         * This field is used in the JSON representation of the command.
         */
        public static final JsonFieldDefinition<String> THING_ID =
                JsonFactory.newStringFieldDefinition("thingId", JsonSchemaVersion.V_2);
