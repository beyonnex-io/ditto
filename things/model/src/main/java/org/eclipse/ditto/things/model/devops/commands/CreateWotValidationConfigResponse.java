...
public final class CreateWotValidationConfigResponse extends AbstractWotValidationConfigCommandResponse<CreateWotValidationConfigResponse>
        implements WithEntity<CreateWotValidationConfigResponse> {
    ...
    public static CreateWotValidationConfigResponse fromJson(final org.eclipse.ditto.json.JsonObject jsonObject, final DittoHeaders dittoHeaders) {
