...
/**
 * Abstract base class for all WoT (Web of Things) validation configuration events.
 * This class provides common functionality and state for all WoT validation config events,
 * including the configuration ID, revision, timestamp, headers, and metadata.
 *
 * <p>
 * All events in this hierarchy are immutable and thread-safe. They are used to track changes
 * to the WoT validation configuration in the event journal and to notify subscribers about
...
public abstract class AbstractWotValidationConfigEvent<T extends AbstractWotValidationConfigEvent<T>>
    ...
    /**
     * Checks if the given object can be equal to this one.
     * This method is used by {@link #equals(Object)} to ensure type safety.
     *
     * @param other the object to check
     * @return true if the other object is an instance of {@code AbstractWotValidationConfigEvent}
     */
    @Override
