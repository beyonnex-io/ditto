...
public final class ImmutableConfigOverrides implements ConfigOverrides{
    ...
    @Override
    public Optional<Boolean> getLogWarningInsteadOfFailingApiCalls() {
    ...
    public JsonObject toJson() {
        ...
        getLogWarningInsteadOfFailingApiCalls().ifPresent(value -> builder.set(LOG_WARNING_INSTEAD_OF_FAILING_FIELD, value));
