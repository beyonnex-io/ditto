...
/**
 * Event that is emitted after a WoT (Web of Things) validation configuration has been deleted.
 ...
 * deletion and to maintain an audit trail of WoT validation settings.
 * </p>
 *
 * @since 3.8.0
 */
...
public final class WotValidationConfigDeleted extends AbstractWotValidationConfigEvent<WotValidationConfigDeleted> {
     ...
     * @throws org.eclipse.ditto.json.JsonParseException if the JSON object is not in the expected format
     */
