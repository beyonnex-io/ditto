 ...
 */
public interface WotValidationConfigEvent<T extends WotValidationConfigEvent<T>> extends Event<T>, EventsourcedEvent<T>, Jsonifiable.WithPredicate<JsonObject, JsonField> {
