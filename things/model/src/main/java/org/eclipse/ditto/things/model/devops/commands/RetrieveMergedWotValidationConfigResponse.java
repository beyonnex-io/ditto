 ...
 * <p>
 * This response contains a set of WoT (Web of Things) validation configurations that have been merged with static
 ...
 * </ul>
 * <p>
 * This response is immutable and thread-safe.
 * </p>
 *
 * @since 3.8.0
 */
...
public final class RetrieveMergedWotValidationConfigResponse extends AbstractCommandResponse<RetrieveMergedWotValidationConfigResponse>
     ...
     * into an {@link ImmutableWotValidationConfig} object.
     */
            ...
            CommandResponseJsonDeserializer.newInstance(TYPE,
                    context -> {
                        ...
                        final JsonObject configObj = jsonObject.getValue(JSON_CONFIG)
                                ...
                                .asObject();
                        final ImmutableWotValidationConfig config = ImmutableWotValidationConfig.fromJson(configObj);
     ...
     */
    private RetrieveMergedWotValidationConfigResponse(final ImmutableWotValidationConfig config,
     ...
     * @throws NullPointerException if any argument is {@code null}.
     */
    public static RetrieveMergedWotValidationConfigResponse of(final ImmutableWotValidationConfig config,
            final DittoHeaders dittoHeaders) {
    ...
    public RetrieveMergedWotValidationConfigResponse setEntity(final JsonValue entity) {
        // Expecting entity to be a JsonObject
        if (entity.isObject()) {
            final ImmutableWotValidationConfig newConfig = ImmutableWotValidationConfig.fromJson(entity.asObject());
