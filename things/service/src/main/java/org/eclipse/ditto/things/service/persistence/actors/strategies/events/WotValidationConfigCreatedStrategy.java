 ...
 */
@Immutable
final class WotValidationConfigCreatedStrategy extends AbstractThingEventStrategy<WotValidationConfigCreated> {

    @Override
    protected ThingBuilder.FromCopy applyEvent(final WotValidationConfigCreated event,
