...
/**
 * Collection of command strategies for WoT (Web of Things) validation config commands.
 * <p>
...
public final class WotValidationConfigCommandStrategies
        extends AbstractCommandStrategies<Command<?>, ImmutableWotValidationConfig, WotValidationConfigId, WotValidationConfigEvent<?>> {
    ...
    private void addStrategies(final ActorSystem system) {
        ...
        addStrategy(new ModifyDynamicConfigSectionStrategy(ddata));
