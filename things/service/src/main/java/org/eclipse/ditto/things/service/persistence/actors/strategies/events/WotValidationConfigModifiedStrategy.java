 ...
 */
final class WotValidationConfigModifiedStrategy implements EventStrategy<WotValidationConfigModified, ImmutableWotValidationConfig> {

    @Override
    public ImmutableWotValidationConfig handle(final WotValidationConfigModified event,
