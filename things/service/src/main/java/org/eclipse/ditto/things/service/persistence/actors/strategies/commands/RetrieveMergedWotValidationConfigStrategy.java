...
/**
 * Strategy for handling the {@link org.eclipse.ditto.things.model.devops.commands.RetrieveMergedWotValidationConfig} command.
 * <p>
...
final class RetrieveMergedWotValidationConfigStrategy extends AbstractWotValidationConfigCommandStrategy<RetrieveMergedWotValidationConfig> {
     ...
     */
    @Override
    protected Optional<Metadata> calculateRelativeMetadata(@Nullable final ImmutableWotValidationConfig entity,
    ...
    protected Result<WotValidationConfigEvent<?>> doApply(final CommandStrategy.Context<WotValidationConfigId> context,
        ...
        // Use the utility class to merge configs
        final ImmutableWotValidationConfig mergedConfig = WotValidationConfigUtils.mergeConfigs(entity, staticConfig);
    ...
    public Optional<EntityTag> nextEntityTag(final RetrieveMergedWotValidationConfig command,
            @Nullable final ImmutableWotValidationConfig nextEntity) {
